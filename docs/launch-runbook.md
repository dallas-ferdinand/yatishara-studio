...
2. Confirm BytePlus ModelArk model IDs on Convex:
   - text: `GATEWAY_TEXT_MODEL_ID` (`dola-seed-2-1-turbo-260628`)
   - assistant: `GATEWAY_ASSISTANT_MODEL_ID` (`dola-seed-2-1-turbo-260628`)
   - DM Improve: `GATEWAY_DM_IMPROVE_MODEL_ID` (`dola-seed-2-1-turbo-260628`)
