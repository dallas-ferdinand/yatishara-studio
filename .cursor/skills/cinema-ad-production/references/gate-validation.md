...
- G-C seedance translation: `generation_prompt` ≤100 words, `SCENE:` + `CAMERA:`; **seedance-translator** scrutiny required ([seedance-translation-foundation.md](seedance-translation-foundation.md))
