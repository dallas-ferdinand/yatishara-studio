...
**Mandatory read:** story-architect (Phase A), editor (Phase C first), directors (merge), dp, gaffer, sound-designer, seedance-translator (scrutiny).
...
Companions: [storytelling-foundation.md](storytelling-foundation.md) (peak-end), [shot-sequence-grammar.md](shot-sequence-grammar.md) (energy curve), [camera-grammar-for-gen.md](camera-grammar-for-gen.md) (travel in 4s gens), [sound-foundation.md](sound-foundation.md) (silence ms).
...
| **C scrutiny** | seedance-translator | Beat times ≤ gen duration |
