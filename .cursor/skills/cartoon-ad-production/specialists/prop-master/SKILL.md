...
description: >-
  Prop master for cartoon ad production. Defines stylized prop specs, writes
  cartoon turnaround sheet prompts, scrutinizes generated images (must view). Use in Phase D visual assets. Explicit
  invocation only.
