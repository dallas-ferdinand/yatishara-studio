...
MCP defaults (and production runs) send **your finished prompt text straight to the image/video model** — **no secondary pass** through `GATEWAY_TEXT_MODEL_ID` (Flash/Gemini).
