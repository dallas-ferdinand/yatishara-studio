...
**Research foundation:** [2d-depth-illusion-foundation.md](2d-depth-illusion-foundation.md) — multiplane, parallax ratios, framing, Klaus-style volume.  
...
When camera moves, layers move at **different speeds** — strong depth affordance (Grodal; Voodla empathy-depth studies; Disney multiplane / 2.5D parallax).

**Default speed ratios (lateral track):** FG ~100% · MG ~55–65% · BG ~25–35% of camera travel. See [2d-depth-illusion-foundation.md](2d-depth-illusion-foundation.md) §2.
...
| `research:multiplane-disney` | Multiplane camera / digital 2.5D — [2d-depth-illusion-foundation.md](2d-depth-illusion-foundation.md) |
| `research:klaus-light-shadow` | Volumetric light on 2D drawings |

## Related

- [2d-depth-illusion-foundation.md](2d-depth-illusion-foundation.md) — full research synthesis
