...
**Translation layer:** [cartoon-translation-foundation.md](cartoon-translation-foundation.md) — word budgets, STILL vs MOTION split, field mapping, worked examples.
...
- [2d-depth-illusion-foundation.md](2d-depth-illusion-foundation.md) — research synthesis: multiplane, framing, parallax ratios, Klaus volume
...
```
[Look prefix from cartoon-look-foundation.md]
...
- [cartoon-look-foundation.md](cartoon-look-foundation.md) — film grain / anti-gloss **look** prefix (not camera moves)
