...
- **Scrutiny:** all Phase C builders + character-continuity + **toon-translator** + **continuity-supervisor**
...
| C | editor (+ dp, gaffer, sound, composer, motion, color) | director-* | all C builders + character-continuity + toon-translator + continuity-supervisor |
