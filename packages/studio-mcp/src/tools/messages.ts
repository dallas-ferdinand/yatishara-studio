...
export function registerMessageTools(server: McpServer) {
  ...
  server.tool(
    ...
    async ({ conversationId, assetId, caption, replyToMessageId }) =>
      jsonResult(
        await studioFetch(
  ...
  server.tool(
    ...
    async ({ conversationId, assetId, durationSec, replyToMessageId }) =>
      jsonResult(
        await studioFetch(
  ...
  server.tool(
    ...
    async ({ conversationId, postId, commentId, note }) =>
      jsonResult(
        await studioFetch(
