...
export function registerProductionTools(server) {
    server.tool("studio_validate_production_gates", `Pre-flight gate check for @cinema-ad-production before studio_generate_* calls. Pass production-state.json as productionState. Returns canProceed, blockers, warnings. REQUIRED before Phase D/E generate per gate-validation.md.`, {
        targetPhase: z
