...
function registerAssistanceTools(server) {
  server.tool(
    "studio_ensure_brief",
  ...
  server.tool(
    ...
    async ({ briefId, expectedRevision, production }) => jsonResult(
  ...
  server.tool(
    ...
    async ({ briefId, expectedRevision, reason }) => jsonResult(
  ...
  server.tool(
    ...
    async ({ approvalId, decision }) => jsonResult(
