...
function buildDeskPalette(scheme, isLight) {
  if (isLight) {
    return {
      ...
      border: hairlineBorder(true, 0.09),
      borderSoft: hairlineBorder(true, 0.06),
      borderSubtle: hairlineBorder(true, 0.075),
