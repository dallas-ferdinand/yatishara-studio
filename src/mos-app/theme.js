...
const LIGHT_BASE = {
  // Soft light chrome: no pure white; greys stay lighter than a heavy plate.
  bg: "#ececf0",
  surface: "#f5f5f7",
  raised: "#e1e1e7",
  text: "#1c1c1e",
...
function buildDeskPalette(scheme, isLight) {
  ...
  const plateStrong = deepenDarkSurface(scheme.raised, 0.28, 0.145);
