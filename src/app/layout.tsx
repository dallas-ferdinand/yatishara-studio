      ...
      <head>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `.ys-boot-v3-overlay{position:fixed;inset:0;z-index:2147483000;background:#fff}.ys-boot-v3{position:relative;box-sizing:border-box;width:100%;min-height:100svh;min-height:100dvh;margin:0;padding:0;overflow:hidden;background:#fff;color:#0f172a}.ys-boot-v3-overlay .ys-boot-v3{position:absolute;inset:0;min-height:0;height:auto}.ys-boot-v3-logo{position:absolute;top:calc(50% + (env(safe-area-inset-top,0px) - env(safe-area-inset-bottom,0px)) / 2);left:50%;width:48px;height:48px;transform:translate(-50%,-50%)}.ys-boot-v3-logo img{display:block;width:48px;height:48px;object-fit:contain}.ys-boot-v3-details{position:absolute;top:calc(50% + (env(safe-area-inset-top,0px) - env(safe-area-inset-bottom,0px)) / 2 + 38px);left:50%;display:flex;width:max-content;max-width:calc(100vw - 48px);flex-direction:column;align-items:center;transform:translateX(-50%);padding:0 24px;box-sizing:border-box}.ys-boot-v3-wordmark{margin:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;font-size:13px;font-weight:600;letter-spacing:.08em;line-height:1.2;color:rgb(15 23 42/.62);white-space:nowrap}.ys-boot-v3-track{margin-top:22px;width:112px;height:2px;overflow:hidden;border-radius:999px;background:rgb(15 23 42/.12)}.ys-boot-v3-bar{height:100%;width:38%;border-radius:999px;background:rgb(15 23 42/.5);animation:ys-boot-v3-bar 1.15s ease-in-out infinite}@keyframes ys-boot-v3-bar{0%{transform:translateX(-120%)}100%{transform:translateX(320%)}}`,
          }}
        />
