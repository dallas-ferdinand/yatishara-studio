      ...
      <head>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `.ys-boot-overlay{position:fixed;inset:0;z-index:2147483000;background:#f5f5f7}.ys-boot{box-sizing:border-box;display:flex;width:100%;min-height:100svh;min-height:100dvh;margin:0;padding:0;overflow:hidden;align-items:center;justify-content:center;background:#f5f5f7;color:#0f172a}.ys-boot-overlay .ys-boot{position:absolute;inset:0;min-height:0;height:auto}.ys-boot-stack{display:flex;flex-direction:column;align-items:center;justify-content:center;width:max-content;max-width:calc(100vw - 48px);padding:0 24px;box-sizing:border-box}.logo-loader{--logo-loader-ring:56px;--logo-loader-mark:34px;--logo-loader-shadow-tight:0 0 5px rgba(0,0,0,.07);--logo-loader-shadow-wide:0 0 20px rgba(0,0,0,.12),0 0 8px rgba(0,0,0,.07);position:relative;display:grid;place-items:center;width:var(--logo-loader-ring);height:var(--logo-loader-ring);flex-shrink:0;border-radius:999px;overflow:visible;background:transparent}.logo-loader-breathe{position:relative;display:grid;place-items:center;width:100%;height:100%;border-radius:999px;background:transparent;overflow:visible;animation:logo-loader-breathe-scale 2.6s ease-in-out infinite}.logo-loader-aura{position:absolute;inset:0;border-radius:50%;background:transparent;pointer-events:none;animation:logo-loader-breathe-shadow 2.6s ease-in-out infinite}.logo-loader-glass{position:absolute;inset:0;border-radius:50%;border:1px solid rgba(27,31,36,.12);background:rgba(255,255,255,.42);clip-path:circle(50% at 50% 50%);-webkit-clip-path:circle(50% at 50% 50%);animation:logo-loader-breathe-fade 2.6s ease-in-out infinite;pointer-events:none}.logo-loader-spin{position:relative;z-index:1;display:grid;place-items:center;width:var(--logo-loader-mark);height:var(--logo-loader-mark);border-radius:999px;background:transparent;animation:logo-loader-spin 5.5s linear infinite}.logo-loader-mark{display:block;width:var(--logo-loader-mark);height:var(--logo-loader-mark);object-fit:contain;background:transparent;opacity:.82;filter:drop-shadow(0 0 4px rgba(0,0,0,.08));animation:logo-loader-breathe-fade 2.6s ease-in-out infinite}@keyframes logo-loader-spin{to{transform:rotate(360deg)}}@keyframes logo-loader-breathe-scale{0%,100%{transform:scale(.84)}50%{transform:scale(1)}}@keyframes logo-loader-breathe-fade{0%,100%{opacity:.38}50%{opacity:1}}@keyframes logo-loader-breathe-shadow{0%,100%{opacity:.32;box-shadow:var(--logo-loader-shadow-tight)}50%{opacity:.7;box-shadow:var(--logo-loader-shadow-wide)}}@media (prefers-reduced-motion:reduce){.logo-loader-spin,.logo-loader-breathe,.logo-loader-aura,.logo-loader-glass,.logo-loader-mark{animation:none}.logo-loader-breathe{transform:none}.logo-loader-aura{opacity:.55;box-shadow:var(--logo-loader-shadow-wide)}.logo-loader-glass,.logo-loader-mark{opacity:.82}}`,
          }}
        />
