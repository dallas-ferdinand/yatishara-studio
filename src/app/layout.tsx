      ...
      <head>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `.ys-boot-v2-overlay{position:fixed;inset:0;z-index:2147483000;background:#fff}.ys-boot-v2{position:relative;display:flex;box-sizing:border-box;min-height:100vh;min-height:100dvh;width:100%;align-items:center;justify-content:center;padding:0;overflow:hidden;margin:0;background:#fff;color:#0f172a}.ys-boot-v2-overlay .ys-boot-v2{min-height:100%;height:100%}.ys-boot-v2-stack{position:relative;display:flex;align-items:center;justify-content:center;padding:0 24px}.ys-boot-v2-logo{width:48px;height:48px;flex:0 0 48px}.ys-boot-v2-logo img{display:block;width:48px;height:48px;object-fit:contain}.ys-boot-v2-details{position:absolute;top:calc(100% + 14px);left:50%;display:flex;width:max-content;flex-direction:column;align-items:center;transform:translateX(-50%)}.ys-boot-v2-wordmark{margin:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;font-size:13px;font-weight:600;letter-spacing:.08em;line-height:1.2;color:rgb(15 23 42/.62);white-space:nowrap}.ys-boot-v2-track{margin-top:22px;width:112px;height:2px;overflow:hidden;border-radius:999px;background:rgb(15 23 42/.12)}.ys-boot-v2-bar{height:100%;width:38%;border-radius:999px;background:rgb(15 23 42/.5);animation:ys-boot-v2-bar 1.15s ease-in-out infinite}@keyframes ys-boot-v2-bar{0%{transform:translateX(-120%)}100%{transform:translateX(320%)}}`,
          }}
        />
