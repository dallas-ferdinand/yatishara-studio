      ...
      <head>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `.ys-boot-v4-overlay{position:fixed;inset:0;z-index:2147483000;background:#fff}.ys-boot-v4{box-sizing:border-box;display:flex;width:100%;min-height:100svh;min-height:100dvh;margin:0;padding:0;overflow:hidden;align-items:center;justify-content:center;background:#fff;color:#0f172a}.ys-boot-v4-overlay .ys-boot-v4{position:absolute;inset:0;min-height:0;height:auto}.ys-boot-v4-stack{display:flex;flex-direction:column;align-items:center;justify-content:center;width:max-content;max-width:calc(100vw - 48px);padding:0 24px;box-sizing:border-box}.ys-boot-v4-logo{width:48px;height:48px;flex:0 0 auto}.ys-boot-v4-logo img{display:block;width:48px;height:48px;object-fit:contain}.ys-boot-v4-wordmark{margin:14px 0 0;font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;font-size:13px;font-weight:600;letter-spacing:.08em;line-height:1.2;color:rgb(15 23 42/.62);white-space:nowrap}.ys-boot-v4-track{margin-top:22px;width:112px;height:2px;overflow:hidden;border-radius:999px;background:rgb(15 23 42/.12)}.ys-boot-v4-bar{height:100%;width:38%;border-radius:999px;background:rgb(15 23 42/.5);animation:ys-boot-v4-bar 1.15s ease-in-out infinite}@keyframes ys-boot-v4-bar{0%{transform:translateX(-120%)}100%{transform:translateX(320%)}}`,
          }}
        />
