...
const TITLE_MAP: Record<string, string> = {
  ...
  remember_update: "Update memory",
  remember_forget: "Forget memory",
  ...
  studio_list_help_requests: "List questions",
  studio_get_help_request: "Open question",
  studio_unlock_help_answer: "Unlock answer",
  studio_undo_help_unlock: "Undo unlock",
...
const LIVE_TITLE_MAP: Record<string, string> = {
  ...
  "Update memory": "Updating memory",
  "Forget memory": "Forgetting memory",
  ...
  "List questions": "Listing questions",
  "Open question": "Opening question",
  "Unlock answer": "Unlocking answer",
  "Undo unlock": "Undoing unlock",
...
const PAST_TITLE_MAP: Record<string, string> = {
  ...
  "List questions": "Listed questions",
  "Open question": "Opened question",
  "Unlock answer": "Unlocked answer",
  "Undo unlock": "Undid unlock",
