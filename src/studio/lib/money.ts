 ...
 * Starter 50 TTD · Pro 500 TTD · Studio 1000 TTD.
 * Custom amounts allowed at or above the first tier (50 TTD).
 */
export const TOP_UP_TIER_CREDITS = [100, 1000, 2000] as const;
export const TOP_UP_TIER_LABELS = ["Starter", "Pro", "Studio"] as const;
